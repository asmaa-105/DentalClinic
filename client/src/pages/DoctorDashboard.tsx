...
import { Calendar, Clock, User, Phone, Mail, Edit, Trash2, LogOut, Search, Filter } from "lucide-react";
...
export default function DoctorDashboard() {
  ...
  const stats = {
    ...
    today: appointments?.filter(apt => apt.appointmentDate === format(new Date(), "yyyy-MM-dd")).length || 0
  };
